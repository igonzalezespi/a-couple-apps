...
Ship the repository as a clean open-source project: an MIT license with attribution, the core documentation set, and a documented fork-for-your-own-couple flow that runs the apps with no source edits beyond configuration.
