...
Provide shared lint, format, and TypeScript configuration consumed by every workspace member, and enforce Conventional Commits plus local gates (lint-staged, pre-push mirroring CI) so quality is consistent and a green push implies green CI.
