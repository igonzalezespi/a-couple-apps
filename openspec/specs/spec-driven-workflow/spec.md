...
Host the OpenSpec spec-driven development workflow in the repository: the directory layout, change-proposal artifacts and their schema, and the pruned opsx/osx automation plus Claude Code setup that validate and gate it.
